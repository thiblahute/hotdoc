...
To generate manylinux wheels and sdist, we use the `pypa/manylinux2010_x86_64` docker image,

Generate the wheels and sdist:

    podman run --rm -it -v $PWD:/hotdoc quay.io/pypa/manylinux2010_x86_64 /hotdoc/scripts/manylinux.sh
