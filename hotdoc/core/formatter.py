...
from hotdoc.core.symbols import\
    (FunctionSymbol, CallbackSymbol, ParameterSymbol,
     ReturnItemSymbol, FieldSymbol, QualifiedSymbol, MethodSymbol,
...
class Formatter(Configurable):
    ...
    def __init__(self, extension, searchpath):
        ...
        self._ordering = [InterfaceSymbol, ClassSymbol, MethodSymbol,
    ...
    def _format_page(self, page):
        ...
        if not self._order_by_parent:
            ...
            for parent_name in page.by_parent_symbols.keys():
                ...
                if symbols_details:
                    by_sections.append(by_section_symbols(parent_name, symbols_details))
    ...
    def _format_symbol(self, symbol):
        ...
        symbol.extension_attributes['order_by_section'] = self._order_by_parent and \
            symbol.parent_name
        if format_function:
